...
function Signup() {
    return (
        <div className={`
            ...
            <span className="text-[calc(0.6vw+1rem)] text-[var(--dark-color)] mt-[-32px] font-semibold">Create Account</span>
            ...
            <span className={`text-[calc(0.3vw+0.6rem)] px-[calc(0.6vw+0.4rem)] py-[calc(0.4vw+0.3rem)] transition duration-300 ease-in-out
                cursor-pointer text-[var(--light-color)] hover:text-[var(--pink-color)] bg-[var(--dark-color)]`}>Create Account</span>   
            
            <div className="text-[var(--dark-color)] text-[calc(0.3vw+0.6rem)] py-[calc(0.6vw+0.4rem)]">Already have an account? 
                <span className="text-blue-500 cursor-pointer hover:text-blue-900 transition duration-300 ease-in-out"> Login here</span>
            </div>
