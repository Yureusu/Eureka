...
function About({isDark} : changeTheme) {
    ...
    return (
        <div className={`${isDark? "bg-[var(--dark-color)] text-[var(--light-color)]" : "bg-[var(--light-color)] text-[var(--dark-color)]"}
            h-full w-[96%] flex flex-col items-center justify-center transition duration-300 ease-in-out`}>
            <div className="h-full w-full flex flex-col items-center justify-evenly">
                ...
                <div className="flex-1 flex flex-col items-start justify-center relative p-[calc(0.4vw+0.6rem)] ">
                    ...
                    <span ref={aboutRef} className={`text-[calc(0.4vw+0.8rem)] font-semibold`}>Your smart and efficient campus lost and found system designed to help students, faculty, 
